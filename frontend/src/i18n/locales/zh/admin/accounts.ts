export default {
    accounts: {
      ...
      windowHunter: {
        ...
        hunting: '狩猎中',
        idle: '待命',
        roundsSinceHit: '连续未命中轮次',
        targetAccount: '目标账号 ID',
        autoHint: '自动模式：{enabled} · 退避 {base}min 起、上限 {max}min · 单轮上限 {cap} 出口',
        poolSection: '满血会话池',
        prewarm: '预建 3 条会话',
        prewarming: '建立中…',
        prewarmHint: '窗口命中后立即预建满血 WS 会话（需账号近期有过业务流量）',
        poolEmpty: '暂无满血会话。先"立即狩猎"命中窗口，再点"预建"。',
        sessionFullPower: '满血',
        sample: '采样',
        runLog: '猎手运行日志',
        noRuns: '暂无运行记录',
        ...
        runRunning: '进行中',
        runError: '异常',
        hitProxy: '命中出口 #{proxy}，窗口开启',
        nextRun: '下一轮 {time}',
        pollutionWarning: '警告：探测与采样即污染——每次指纹都会把该出口的窗口时钟归零，并消耗 ~25 token 配额。'
      },
      windowProbe: {
        stateFullPower: '满血',
        stateDegraded: '降智',
