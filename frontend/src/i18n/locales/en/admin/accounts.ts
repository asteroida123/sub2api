export default {
    accounts: {
      ...
      windowHunter: {
        title: 'Window Hunter',
        hunterSection: 'Hunter Status',
        runNow: 'Hunt Now',
        starting: 'Starting…',
        state: 'State',
        hunting: 'Hunting',
        idle: 'Idle',
        roundsSinceHit: 'Missed Rounds',
        targetAccount: 'Target Account ID',
        autoHint: 'Auto: {enabled} · backoff {base}min base / {max}min max · {cap} exits per round',
        poolSection: 'Full-Power Session Pool',
        prewarm: 'Prewarm 3 Sessions',
        prewarming: 'Prewarming…',
        prewarmHint: 'Prewarm full-power WS sessions right after a window hit (account needs recent traffic)',
        poolEmpty: 'No full-power sessions. Hunt for a window first, then prewarm.',
        sessionFullPower: 'Full Power',
        sample: 'Sample',
        runLog: 'Hunter Run Log',
        noRuns: 'No runs yet',
        runHit: 'Hit',
        runMiss: 'Miss',
        runRunning: 'Running',
        runError: 'Error',
        hitProxy: 'Hit exit #{proxy}, window opened',
        nextRun: 'Next round {time}',
        pollutionWarning: 'Warning: probing pollutes — every fingerprint resets the exit\'s window clock and consumes ~25 tokens.'
      },
      windowProbe: {
