...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	windowProbeRepository := repository.NewWindowProbeRepository(client, db)
	windowProbeService := service.ProvideWindowProbeService(accountRepository, proxyRepository, windowProbeRepository, httpUpstream, tlsFingerprintProfileService, settingService, proxyLatencyCache)
	windowProbeHandler := admin.NewWindowProbeHandler(windowProbeService)
	windowHunterService := service.ProvideWindowHunterService(windowProbeService, proxyRepository, proxyLatencyCache, settingService, windowProbeRepository)
	windowHunterHandler := admin.NewWindowHunterHandler(windowHunterService)
	windowSessionPoolService := service.ProvideWindowSessionPoolService(accountRepository, windowProbeRepository, settingService, openAIGatewayService)
	windowSessionPoolHandler := admin.NewWindowSessionPoolHandler(windowSessionPoolService)
